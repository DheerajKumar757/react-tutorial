 ...
 * to the App.
 * 
 * For now, just hard-code in the data, which you can find in japan.md so
 * you do not have to type it all out manually :)
 * 
 * Notes:
 ...
 * - The main purpose of this challenge is to show you where out limitations
